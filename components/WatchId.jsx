    ...
    try {
      ...
      for (let i = 0; i < response.data.results.length; i++) {
        if (response.data.results[i].type == "Trailer") {
          setTrailerLink(
            `https://www.youtube.com/watch?v=${response.data.results[i].key}`
          );
          break;
        }
      }
      ...
      <div className="w-100">
        {router.isReady && (
          <div className="relative w-100">
            <img
              className="imageBackdrop absolute"
            ...
            <div className="watchContainer">
              ...
              <div className="movieContent">
                ...
                <div className="flex">
                  ...
                  <p className="little-m-l">
                    ●{" "}
                    {movieDetails?.genres?.map((data) => data.name).join(", ")}
                  </p>
                ...
                <div className="flex">
                  <div className="h-40 flex item-center">
                    ...
                    <p className="pl-5 pb-5 iconText">
                  ...
                  {trailerLink !== "#" && (
                    <a
                      ...
                      rel="noreferrer"
                      href={trailerLink}
                      className="h-40 trailer flex item-center"
                    >
                    ...
                    if (
                      ...
                      return (
                        <a
                          target="_blank"
                          rel="noreferrer"
                          href={`https://www.google.com/search?q=${data.original_name}`}
                          key={data.id}
                          className="card"
                        >
                          <img
